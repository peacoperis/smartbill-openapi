...
| 14 | **Schimbarea modelului — pornește instanța nouă ÎN ACEST REPO, PE ACEST BRANCH.** Web: repo `peacoperis/smartbill-openapi`, branch `claude/antonia-delegation-management-vvt3xe`. Local: `git fetch origin && git checkout claude/antonia-delegation-management-vvt3xe`, apoi Claude Code din acel director. Prima comandă: **„Citește CLAUDE.md și spune-mi starea într-un rând."** Dacă răspunsul vorbește despre blindaj / PULS / tetto-rc-2d, e alt proiect de pe calculatorul tău, nu acesta (s-a întâmplat pe 03.09) | `CLAUDE.md` există doar pe acest branch; `main` e din februarie și n-are nimic | vezi stânga | acum |
